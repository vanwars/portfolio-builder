    ...
    <div className="space-y-12">
      ...
      <div className="space-y-6">
        <div className="space-y-3">
          ...
          <button className="w-full text-left bg-slate-50 border-2 border-slate-200 rounded-lg p-6 hover:border-blue-400 hover:bg-blue-50 transition-all group">
            <div className="flex items-start gap-4">
              <div className="w-12 h-12 bg-white border border-slate-200 rounded-lg flex items-center justify-center flex-shrink-0 group-hover:border-blue-300">
                <Github className="w-6 h-6 text-slate-600 group-hover:text-blue-600" />
              </div>
              <div>
          ...
          <button className="w-full text-left bg-slate-50 border-2 border-slate-200 rounded-lg p-6 hover:border-blue-400 hover:bg-blue-50 transition-all group">
            <div className="flex items-start gap-4">
              <div className="w-12 h-12 bg-white border border-slate-200 rounded-lg flex items-center justify-center flex-shrink-0 group-hover:border-blue-300">
                <Image className="w-6 h-6 text-slate-600 group-hover:text-blue-600" />
              </div>
              <div>
          ...
          <button className="w-full text-left bg-slate-50 border-2 border-slate-200 rounded-lg p-6 hover:border-blue-400 hover:bg-blue-50 transition-all group">
            <div className="flex items-start gap-4">
              <div className="w-12 h-12 bg-white border border-slate-200 rounded-lg flex items-center justify-center flex-shrink-0 group-hover:border-blue-300">
                <Link2 className="w-6 h-6 text-slate-600 group-hover:text-blue-600" />
              </div>
              <div>
